...
Smart Sorting : Default sorting by Asset Value (High to Low) to prioritize your biggest positions.
...
git clone [https://github.com/yourusername/wall-street-pika.git](https://github.com/yourusername/wall-street-pika.git)
...
Your dashboard will be live at https://yourusername.github.io/wallstreetpika/.

⚙️ Configuration & API Key

This dashboard uses Finnhub.io for stock data.

Important Note on Security:
The current code contains a hardcoded API token. If you plan to make this repository public, it is recommended to:

Get your own free API key from Finnhub.

Replace the const API_KEY variable in the script section.

(Optional) For advanced security, consider asking the user to input their own key via the UI rather than hardcoding it in the file.
